"""Test ProteinChangeAnnotator class of atypical use - MET Exon 14 in-frame deletions."""
...
class ProteinChangeAnnotatorAtypicalMetExon14InframeDeletionTestCase(unittest.TestCase):
    """Test ProteinChangeAnnotator class of atypical use - MET Exon 14 in-frame deletions."""
    ...
    def setUpClass(cls) -> None:
        ...
        annotator = ProteinChangeAnnotator(
            ...
            gene_symbol="MET",
            alteration="Exon 14 in-frame deletions",
            ref_genome="GRCh37",
        )
    ...
    def test_query_alteration(self):
        ...
        if isinstance(self.indicator_query_resp, IndicatorQueryResp):
            self.assertEqual(
                self.indicator_query_resp.query.alteration, "Exon 14 in-frame deletions"
            )
