"""Test ProteinChangeAnnotator class of atypical use - MET Exon 14 splice mutations."""
...
class ProteinChangeAnnotatorAtypicalMetExon14SpliceMutationsTestCase(unittest.TestCase):
    """Test ProteinChangeAnnotator class of atypical use - MET Exon 14 splice mutations."""
    ...
    def setUpClass(cls) -> None:
        ...
        annotator = ProteinChangeAnnotator(
            ...
            gene_symbol="MET",
            alteration="Exon 14 splice mutations",
            ref_genome="GRCh37",
        )
